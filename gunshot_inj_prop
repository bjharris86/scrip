...
aprx = arcpy.mp.ArcGISProject(r"C:\Users\bjharris\Desktop\Maps\gunshot.aprx")
...
shot = m.listLayers("Shooting YTD")[0]
gs = "gunshot_inj_prop"
...
outkdens = KernelDensity(shot,"NONE","25","5280","SQUARE_MILES","DENSITIES","PLANAR")
