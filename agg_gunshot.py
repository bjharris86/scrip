...
aprx = arcpy.mp.ArcGISProject(r"C:\Users\bjharris\Desktop\Maps\agg_gunshot.aprx")
...
gun = m.listLayers("Agg Gunshot YTD")[0]
agg = "vcd_gunshot_agg_assault"
